...
//        MobclickAgent.UMAnalyticsConfig umAnalyticsConfig = new MobclickAgent.UMAnalyticsConfig(getApplication(), AppKeyCons.UMENG_KEY, "default", MobclickAgent.EScenarioType.E_UM_NORMAL);
    ...
    private boolean isLocalProcess() {
        ...
        for (ActivityManager.RunningAppProcessInfo process : manager.getRunningAppProcesses()) {
            if (process.pid == pid) {
                ...
                if (processName.equals("cn.zdxiang.foresee")) {
                    return true;
                }
            }
        }
...
//                        Toast.LENGTH_SHORT).show();
            ...
            public void onPatchRollback() {
                Toast.makeText(getApplication(), "补丁撤回成功", Toast.LENGTH_SHORT).show();
            }
        };
...
//        Bugly.setIsDevelopmentDevice(getApplication(), true);
        ...
        Bugly.init(getApplication(), "f1600a8a86", false);
    }
